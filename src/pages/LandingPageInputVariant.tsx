    ...
    <div className="flex h-screen flex-col bg-bg-light pt-8 dark:bg-bg-dark font-sans text-text-main dark:text-text-main-dark selection:bg-primary/20 overflow-hidden relative">
      ...
      <div className="absolute bottom-8 w-full px-12 flex justify-between items-center text-text-placeholder z-20 pointer-events-none">
        <div className="flex gap-8 pointer-events-auto opacity-70 hover:opacity-100 transition-opacity duration-300">
          <button onClick={() => navigate('/history')} className="text-[12px] font-medium hover:text-text-main transition-colors">{t('landing.sessionHistory')}</button>
        ...
        <div className="pointer-events-auto opacity-70 hover:opacity-100 transition-opacity duration-300">
          ...
          <button onClick={() => navigate('/demo-canvas')} className="text-[12px] font-medium text-yellow-600 hover:text-yellow-500 transition-colors ml-4">
            Canvas Demo
          </button>
        </div>
      </div>
