...
use super::tools;
use super::types::*;
use super::prompt::SocraticPromptBuilder;
use super::client::ApiBackend;
...
pub async fn run_agent_turn(
    ...
    let system_prompt = SocraticPromptBuilder::new(system_prompt).build_legacy();
...
pub async fn run_prep_phase(
    ...
    let augmented_prompt = SocraticPromptBuilder::new(system_prompt).build_prep();
...
pub async fn run_teaching_turn(
    ...
    let augmented_prompt = SocraticPromptBuilder::new(system_prompt).with_lesson_brief(lesson_brief).build_teaching();
    let result = run_phase_loop(
        app, api_key, provider, model, workspace_path, &augmented_prompt,
...
pub async fn run_post_lesson(
    ...
    let augmented_prompt = SocraticPromptBuilder::new(system_prompt).build_post();
    let messages = vec![Message {
        role: "user".to_string(),
        content: vec![ContentBlock::Text {
...
pub async fn run_practice_turn(
    ...
    let augmented_prompt = SocraticPromptBuilder::new(system_prompt).build_practice();
    let result = run_phase_loop(
        app, api_key, provider, model, workspace_path, &augmented_prompt,
...
pub async fn run_meta_prompt_turn(
    ...
    let augmented_prompt = SocraticPromptBuilder::new(system_prompt).build_meta_prompt();
    let result = run_phase_loop(
        app, api_key, provider, model, workspace_path, &augmented_prompt,
...
pub fn get_meta_prompt_content() -> &'static str {
    super::prompt::META_PROMPT_CONTENT
}
